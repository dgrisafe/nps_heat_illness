...
var_id <- c("dispatch_id", "prid")

# demographic variables
var_demographic <- c("name_full", "name_last", "name_first", "name_middle", "age_disp", "gender", "date_of_birth", "race_ethnicity", "phone", "address", "address_line_1", "address_line_2", "city", "state", "country")
...
```{r}
case_confirm <- case_screen %>% 
  filter(case_screen == "Yes") %>% 
  select(prid, dispatch_date, medical_category, patient_activity, hpi)
...
```{r}
saveRDS(df_grca, paste0(dir_data, "\\df_grca.rds"))
```
